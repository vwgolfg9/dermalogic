        ...
        <div id="firstHero"  class="hero is-primary ">
            <div class="hero-body">
                ...
                <div id="subtitle" ref="subtitle" class="subtitle">
                    <h2>
                    Απόκτησε και εσύ το ΤΕΛΕΙΟ ΣΩΜΑ ΑΠΑΛΛΑΓΜΕΝΟ ΑΠΟ ΚΥΤΤΑΡΙΤΙΔΑ ΧΑΛΑΡΩΣΗ ΚΑΙ ΤΟΠΙΚΟ ΠΑΧΟΣ. 
                    Λαβέ μέρος στο διαγωνισμό και κέρδισε 2 θεραπείες
                    i-CONTOUR CAVITATION RF
                    </h2>
                </div>
                <div class="">
